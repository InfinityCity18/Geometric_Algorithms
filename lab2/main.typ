...
Ćwiczenie polegało na wyznaczeniu otoczki wypukłej korzystając z algorytmu Grahama oraz algorytmu Jarvisa, wizualizacji wyników oraz porównania czasów wykonywania dla poniższych zbiorów:
...
W algorytmie Grahama punkty zostały posortowane za pomocą funkcji bibliotecznej ze względu na kąt tworzący z poziomą osią oraz prostą od $p_0$ do rozpatrywanego punktu. Do wykonania tego został użyty wyznacznik macierzy 3x3. Z punktów współliniowych zostawiamy tylko ten z największą odległością od $p_0$.

W algorytmie Jarvisa szukamy punków których kąt w odniesieniu do ostatniej krawędzi jest najmniejszy. Do tego również został wykorzystany wyznacznik 3x3. W przypadku współliniowości, rozpatrujemy tylko dalszy punkt.
...
Oba algorytmy zaklasyfikowały 12 punktów do otoczki wypukłej.
Jest to ukazane na rysunku 1.
